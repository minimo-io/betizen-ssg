...
module.exports = {
  es: {
    ...
    promo: {
      ...
      cta: "👉 ¿120 GIROS GRATIS?",
      image: metadata.images.banners + "casino-banner-3-es.webp",
      casino: {
        logo: "/assets/imgs/casinos/20bet-casino-logo.webp",
        name: "20BET",
        title: "100% HASTA $300 Y 120 GIROS 🤯 ¡PROMO LIMITADA!",
  ...
  "pt-br": {
    ...
    promo: {
      ...
      cta: "👉 RECLAME 120 RODADAS GRÁTIS?",
      image: metadata.images.banners + "casino-banner-3-pt-br.webp",
      casino: {
        logo: "/assets/imgs/casinos/20bet-casino-logo.webp",
        name: "20BET",
        title: "100 ATÉ R$500 E 120 GIROS GRATUITOS 🤯 PROMOÇÃO LIMITADA!",
  ...
  en: {
    ...
    promo: {
      url: "https://media.toxtren.com/redirect.aspx?pid=101348&bid=1942",
      cta: "👉 100% + 120 FREE SPINS?",
      image: metadata.images.banners + "casino-banner-3-en.webp",
      casino: {
        logo: metadata.images.casinos + "20bet-casino-logo.webp",
        name: "20BET",
        title:
          "100% UP TO 180 C$ + 120 FREE SPINS! 🤯 <br>CANNOT MISS THIS ONE!",
        cta: "CLAIM YOUR LUCKY BONUS TODAY!",
      },
      external_250x250: metadata.images.banners + "banner_250x250-en.gif",
    },
    categories: {
