...
try {
  const importXmlFile = "./tools/betizen-sitemaps/proveedores-XML Sitemap.xml";
  const postType = "providers"; // must be the post type inside the ./content/{language_code} directory
