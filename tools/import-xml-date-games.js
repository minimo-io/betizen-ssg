...
try {
  const importXmlFile = "./tools/betizen-sitemaps/juegos-XML Sitemap.xml";
  const postType = "games"; // must be the post type inside the ./content/{language_code} directory
